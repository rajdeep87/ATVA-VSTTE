...
\renewcommand{\vector}[1]{{\boldsymbol #1}}
  ...
  \newcommand{\vecvv}[4]{{\left(\begin{array}{@{}c@{}c@{}c@{}} 
    #1 \\ #2 \\ #3 \\ #4 \end{array}\right)}}
  
  \newcommand{\vecvvv}[8]{{\left(\begin{array}{@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}} 
    #1 \\ #2 \\ #3 \\ #4 \\ #5 \\ #6 \\ #7 \\ #8 \end{array}\right)}}
  
  \newcommand{\hmat}[2]{{\left(\begin{array}{@{}cc} #1 & #2 \end{array}\right)}}
  \newcommand{\qmat}[4]{{\left(\begin{array}{@{}cc@{}} #1 & #2 \\  #3 & #4\end{array}\right)}}
  \newcommand{\qqmat}[8]{{\left(\begin{array}{@{}cc@{}cc@{}cc@{}} #1 & #2 \\  #3 & #4 \\ 
...
\newcommand{\constraints}{\Sigma^\dagger}
...
\newcommand{\conf}[2]{\mathit{conf}_{#1}^{#2}}
\newcommand{\modformula}[2]{\llbracket #1 \rrbracket_{#2}}
...
\newcommand{\ltrans}{$f_{aunsafe}^{G \dagger}$}
